ABOUT
-----
This dataset was generated by the Seedlot Selection Tool (https://seedlotselectiontool.org) on {% now "F j, Y" %}.
...
USING THE DATA
--------------
The file results.tif is a GeoTIFF dataset. This file can be opened using desktop GIS softward such as ArcGIS or QGIS. The value of each cell ranges from 0 - 100 with 0 being the worst possible match and 100 being the best.
